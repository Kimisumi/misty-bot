...
exports.nick = 'Mr. Misty-Eye';
exports.pass = 'turtles1';
 
// The rooms that should be joined.
// Joining Smogon's Showdown's Lobby is not allowed.
exports.rooms = ['earth','bot aboose','the alliance empire','the genesis league','the lunar legacy league'];
...
exports.whitelist = ['Mr. Misty-Eye', 'Elf Flopper', 'Alliance - Kimi'];
 
// Add a link to the help for the bot here. When there is a link here, .help and .guide
// will link to it.
exports.botguide = 'http://pastebin.com/tzXeD4xa';
